...
The project resulted in completing an application delivering performance & reliability metric of the given Software Model. Which is basically my motivation for participating in this Eclipse GSoC project, "CPU-GPU Response Time and Mapping Analysis".
